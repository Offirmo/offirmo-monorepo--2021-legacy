...
},{"@offirmo/globalthis-ponyfill":"cCMb","./v1":"UGlG","@offirmo/universal-debug-api-interface":"K621"}],"EeuL":[function(require,module,exports) {
"use strict";
...
},{}],"h3yt":[function(require,module,exports) {
"use strict";
...
exports.setImmediate = globalthis_ponyfill_1.getGlobalThis().setImmediate || function setImmediatePonyFill(callback) {
  ...
  setTimeout.apply(void 0, __spreadArrays([callback, 0], args));
}; // browser only
...
exports.requestIdleCallback = ((_b = globalthis_ponyfill_1.getGlobalThis().requestIdleCallback) === null || _b === void 0 ? void 0 : _b.bind(globalthis_ponyfill_1.getGlobalThis())) || function requestIdleCallbackPonyFill(callback, _a) {
  ...
  var _b = (_a === void 0 ? {} : _a).timeout,
      timeout = _b === void 0 ? DEFAULT_IDLE_DELAY_MS : _b;
...
},{"tiny-invariant":"EeuL","@offirmo/globalthis-ponyfill":"cCMb"}],"dlbT":[function(require,module,exports) {
"use strict";
...
},{"./ponyfills":"h3yt"}],"s63Q":[function(require,module,exports) {
"use strict";
...
},{"./ponyfills":"h3yt"}],"oiJd":[function(require,module,exports) {
"use strict";
...
},{"./awaitable":"dlbT","./ponyfills":"h3yt","./semantic":"s63Q"}],"JEbM":[function(require,module,exports) {
"use strict";
...
*/
},{"@offirmo/universal-debug-api-placeholder":"N08m","@offirmo-private/async-utils":"oiJd","../../../../2-foundation/practical-logger-core/doc/shared-demo":"NeXk"}]},{},["Focm"], null)
//# sourceMappingURL=demo.5d8afe9e.js.map