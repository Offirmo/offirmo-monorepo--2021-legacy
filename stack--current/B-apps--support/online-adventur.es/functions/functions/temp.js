...
const {stdout: stdoutColor, stderr: stderrColor} = __webpack_require__(84);
const {
	stringReplaceAll,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return is_WithSchemaVersion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return is_WithRevision; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return is_WithTimestamp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return is_WithLastUserInvestmentTimestamp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return has_versioned_schema; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return is_revisioned; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return is_time_stamped; });
...
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
function fluid_select(stateA) {
  ...
  return {
    ...
    has_same_schema_version_than(stateB) {
      const schema_version__B = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_schema_version_loose */ "g"])(stateB);
      return schema_version__A === schema_version__B;
    },

    has_higher_or_equal_schema_version_than(stateB) {
      const schema_version__B = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_schema_version_loose */ "g"])(stateB);
      return schema_version__A >= schema_version__B;
    },

    has_higher_schema_version_than(stateB) {
      const schema_version__B = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_schema_version_loose */ "g"])(stateB);
      return schema_version__A > schema_version__B;
    },

    // has actual difference, not just timestamp
    has_valuable_difference_with(stateB) {
      ...
      const revision__A = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_revision_loose */ "e"])(stateA);
      const revision__B = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_revision_loose */ "e"])(stateB);
      return revision__A !== revision__B; // no order here
    },

    has_higher_investment_than(stateB) {
      // NO!
      ...
      const activity_tms__A = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_last_user_activity_timestamp_loose */ "c"])(stateA);
      const activity_tms__B = Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_last_user_activity_timestamp_loose */ "c"])(stateB);
    ...
    get_debug_infos_about_comparison_with(stateB, nickname__a = 'A', nickname__b = 'B') {
      return {
        [nickname__a]: Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_base_loose */ "a"])(stateA),
        [nickname__b]: Object(_selectors__WEBPACK_IMPORTED_MODULE_0__[/* get_base_loose */ "a"])(stateB)
      };
    }
...
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
...
function generic_migrate_to_latest({
  ...
  return SEC.xTry('migrate_to_latest', ({
    ...
    const existing_version = Object(_selectors__WEBPACK_IMPORTED_MODULE_2__[/* get_schema_version_loose */ "g"])(legacy_state);
      ...
      function previous(index, SEC, legacy_state, hints) {
        ...
        return RSEC.xTry('migration step:' + current_step_name, ({
          ...
          if (index >= pipeline.length) {
            throw new Error(`No known migration for updating a v${Object(_selectors__WEBPACK_IMPORTED_MODULE_2__[/* get_schema_version_loose */ "g"])(legacy_state)}!`);
          }
    ...
    if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_UTBundle */ "f"])(state)) {
      ...
      Object(tiny_invariant__WEBPACK_IMPORTED_MODULE_0__["default"])(false, 'should be a recognized AnyOffirmoState!');
    }
...
/* harmony import */ var _offirmo_private_timestamps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(75);
/* harmony import */ var _type_guards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4);





const enforce_immutability = state => icepick__WEBPACK_IMPORTED_MODULE_1___default.a.freeze(state);
function get_mutable_copy(state) {
  return icepick__WEBPACK_IMPORTED_MODULE_1___default.a.thaw(state);
...
const Sentry = __webpack_require__(172);
...
const assert_1 = __importDefault(__webpack_require__(55));
const debug_1 = __importDefault(__webpack_require__(56));
const agent_base_1 = __webpack_require__(141);
const parse_proxy_response_1 = __importDefault(__webpack_require__(143));
...
module.exports = __webpack_require__(89)(exports);
...
__webpack_require__.d(__webpack_exports__, "Session", function() { return /* reexport */ session_Session; });
...
__webpack_require__.d(__webpack_exports__, "flush", function() { return /* reexport */ sdk_flush; });
...
__webpack_require__.d(transports_namespaceObject, "makeNodeTransport", function() { return makeNodeTransport; });
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/is.js
...
var time = __webpack_require__(286);
...
function rejectedSyncPromise(reason) {
    return new syncpromise_SyncPromise(function (_, reject) {
        reject(reason);
    });
}
/**
...
var esm_global = __webpack_require__(10);
...
var scope_Scope = /** @class */ (function () {
    ...
    Scope.prototype.setSDKProcessingMetadata = function (newData) {
        this._sdkProcessingMetadata = tslib_es6_assign(tslib_es6_assign({}, this._sdkProcessingMetadata), newData);
        return this;
    };
    /**
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/string.js
...
function convertToPlainObject(value) {
    var newObj = value;
    if (isError(value)) {
        newObj = node_modules_tslib_tslib_es6_assign({ message: value.message, name: value.name, stack: value.stack }, getOwnProperties(value));
    }
    else if (isEvent(value)) {
        var event_1 = value;
        newObj = node_modules_tslib_tslib_es6_assign({ type: event_1.type, target: serializeEventTarget(event_1.target), currentTarget: serializeEventTarget(event_1.currentTarget) }, getOwnProperties(event_1));
...
function dropUndefinedKeys(val) {
    ...
    if (isPlainObject(val)) {
        var rv = {};
        try {
            for (var _b = node_modules_tslib_tslib_es6_values(Object.keys(val)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/misc.js
...
function addExceptionMechanism(event, newMechanism) {
    ...
    firstException.mechanism = node_modules_tslib_tslib_es6_assign(node_modules_tslib_tslib_es6_assign(node_modules_tslib_tslib_es6_assign({}, defaultMechanism), currentMechanism), newMechanism);
    if (newMechanism && 'data' in newMechanism) {
        var mergedData = node_modules_tslib_tslib_es6_assign(node_modules_tslib_tslib_es6_assign({}, (currentMechanism && currentMechanism.data)), newMechanism.data);
...
var esm_env = __webpack_require__(20);
...
var logger_global = Object(esm_global["a" /* getGlobalObject */])();
...
var logger_Logger = /** @class */ (function () {
    ...
    Logger.prototype.log = function () {
        ...
        consoleSandbox(function () {
            var _a;
            (_a = logger_global.console).log.apply(_a, node_modules_tslib_tslib_es6_spread([PREFIX + "[Log]:"], args));
        });
    };
    /** JSDoc */
    Logger.prototype.warn = function () {
        ...
        consoleSandbox(function () {
            var _a;
            (_a = logger_global.console).warn.apply(_a, node_modules_tslib_tslib_es6_spread([PREFIX + "[Warn]:"], args));
        });
    };
    /** JSDoc */
    Logger.prototype.error = function () {
        ...
        consoleSandbox(function () {
            var _a;
            (_a = logger_global.console).error.apply(_a, node_modules_tslib_tslib_es6_spread([PREFIX + "[Error]:"], args));
        });
    };
    return Logger;
}());
var sentryGlobal = logger_global.__SENTRY__ || {};
var logger = sentryGlobal.logger || new logger_Logger();
if (Object(esm_env["b" /* isDebugBuild */])()) {
    // Ensure we only have a single logger instance, even if multiple versions of @sentry/utils are being used
    sentryGlobal.logger = logger;
    logger_global.__SENTRY__ = sentryGlobal;
}
...
var hub_Hub = /** @class */ (function () {
    ...
    Hub.prototype.getIntegration = function (integration) {
        ...
        try {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn("Cannot retrieve integration " + integration.id + " from the current Hub");
            return null;
        }
    };
    /**
    ...
    Hub.prototype.startSession = function (context) {
        ...
        var session = new session_Session(tslib_es6_assign(tslib_es6_assign(tslib_es6_assign({ release: release,
    ...
    Hub.prototype._callExtensionMethod = function (method) {
        ...
        Object(esm_env["b" /* isDebugBuild */])() && logger.warn("Extension method " + method + " couldn't be found, doing nothing.");
    };
    return Hub;
}());
...
function getActiveDomain() {
    Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Function `getActiveDomain` is deprecated and will be removed in a future version.');
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/envelope.js
...
function addItemToEnvelope(envelope, newItem) {
    var _a = node_modules_tslib_tslib_es6_read(envelope, 2), headers = _a[0], items = _a[1];
    return [headers, node_modules_tslib_tslib_es6_spread(items, [newItem])];
}
/**
 * Get the type of the envelope. Grabs the type from the first envelope item.
 */
function getEnvelopeType(envelope) {
    var _a = node_modules_tslib_tslib_es6_read(envelope, 2), _b = node_modules_tslib_tslib_es6_read(_a[1], 1), _c = node_modules_tslib_tslib_es6_read(_b[0], 1), firstItemHeader = _c[0];
...
function serializeEnvelope(envelope) {
    ...
    return items.reduce(function (acc, item) {
        var _a = node_modules_tslib_tslib_es6_read(item, 2), itemHeaders = _a[0], payload = _a[1];
...
function createStackParser() {
    ...
    return function (stack, skipFirst) {
        ...
        var frames = [];
        try {
            for (var _c = node_modules_tslib_tslib_es6_values(stack.split('\n').slice(skipFirst)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var line = _d.value;
                try {
                    for (var sortedParsers_1 = (e_2 = void 0, node_modules_tslib_tslib_es6_values(sortedParsers)), sortedParsers_1_1 = sortedParsers_1.next(); !sortedParsers_1_1.done; sortedParsers_1_1 = sortedParsers_1.next()) {
...
function stripSentryFramesAndReverse(stack) {
    ...
    return localStack
        ...
        .map(function (frame) { return (node_modules_tslib_tslib_es6_assign(node_modules_tslib_tslib_es6_assign({}, frame), { filename: frame.filename || localStack[0].filename, function: frame.function || '?' })); })
        .reverse();
}
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/normalize.js
...
function visit(key, value, depth, maxProperties, memo) {
    ...
    var _a = node_modules_tslib_tslib_es6_read(memo, 2), memoize = _a[0], unmemoize = _a[1];
...
function createSessionEnvelope(session, api) {
    ...
    var envelopeHeaders = core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({ sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (!!api.tunnel && { dsn: dsnToString(api.dsn) }));
...
function sessionToSentryRequest(session, api) {
    var _a = core_node_modules_tslib_tslib_es6_read(createSessionEnvelope(session, api), 2), envelope = _a[0], type = _a[1];
    return {
...
function createEventEnvelope(event, api) {
    ...
    var envelopeHeaders = core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({ event_id: event.event_id, sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (!!api.tunnel && { dsn: dsnToString(api.dsn) }));
    var eventItem = [
        {
            type: eventType,
...
var basebackend_BaseBackend = /** @class */ (function () {
    ...
    function BaseBackend(options) {
        ...
        if (!this._options.dsn) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('No DSN provided, backend will not do anything.');
        }
    ...
    BaseBackend.prototype.sendEvent = function (event) {
        ...
        if (this._newTransport &&
            ...
            void this._newTransport.send(env).then(null, function (reason) {
                Object(esm_env["b" /* isDebugBuild */])() && logger.error('Error while sending event:', reason);
            });
        }
        else {
    ...
    BaseBackend.prototype.sendSession = function (session) {
        if (!this._transport.sendSession) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn("Dropping session because custom transport doesn't implement sendSession");
            return;
        }
        // TODO(v7): Remove the if-else
        if (this._newTransport &&
            ...
            this._options._experiments.newTransport) {
            var api = initAPIDetails(this._options.dsn, this._options._metadata, this._options.tunnel);
            var _a = core_node_modules_tslib_tslib_es6_read(createSessionEnvelope(session, api), 1), env = _a[0];
            void this._newTransport.send(env).then(null, function (reason) {
                Object(esm_env["b" /* isDebugBuild */])() && logger.error('Error while sending session:', reason);
            });
        }
        else {
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/node/esm/stack-parser.js
...
function getModule(filename) {
    ...
    var base = (( true && __webpack_require__.c[__webpack_require__.s] && __webpack_require__.c[__webpack_require__.s].filename && dirname(__webpack_require__.c[__webpack_require__.s].filename)) || global.process.cwd()) + "/";
...
// eslint-disable-next-line complexity
var stack_parser_node = function (line) {
    var _a;
...
var nodeStackParser = [90, stack_parser_node];
...
function makePromiseBuffer(limit) {
    ...
    function add(taskProducer) {
        if (!isReady()) {
            return rejectedSyncPromise(new error_SentryError('Not adding Promise due to buffer limit reached.'));
        }
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/ratelimit.js
...
function updateRateLimits(limits, headers, now) {
    var e_1, _a, e_2, _b;
    if (now === void 0) { now = Date.now(); }
    var updatedRateLimits = node_modules_tslib_tslib_es6_assign({}, limits);
    ...
    if (rateLimitHeader) {
        try {
             ...
             */
            for (var _c = node_modules_tslib_tslib_es6_values(rateLimitHeader.trim().split(',')), _d = _c.next(); !_d.done; _d = _c.next()) {
                var limit = _d.value;
                ...
                if (!parameters[1]) {
                    ...
                    try {
                        for (var _e = (e_2 = void 0, node_modules_tslib_tslib_es6_values(parameters[1].split(';'))), _f = _e.next(); !_f.done; _f = _e.next()) {
...
var http_HTTPTransport = /** @class */ (function (_super) {
    ...
    function HTTPTransport(options) {
        ...
        _this.client = proxy
            ? new (__webpack_require__(54))(proxy)
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/core/esm/transports/base.js
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/node/esm/transports/new.js
...
function makeNodeTransport(options) {
    var _a;
    var urlSegments = new external_url_["URL"](options.url);
    ...
    var nativeHttpModule = isHttps ? external_https_ : external_http_;
...
function createRequestExecutor(options, httpModule, agent) {
    var _a = new external_url_["URL"](options.url), hostname = _a.hostname, pathname = _a.pathname, port = _a.port, protocol = _a.protocol, search = _a.search;
...
function getIntegrationsToSetup(options) {
    ...
    var integrations = core_node_modules_tslib_tslib_es6_spread(filterDuplicates(defaultIntegrations));
    if (Array.isArray(userIntegrations)) {
        // Filter out integrations that are also included in user options
        integrations = core_node_modules_tslib_tslib_es6_spread(integrations.filter(function (integrations) {
...
function setupIntegration(integration) {
    ...
    Object(esm_env["b" /* isDebugBuild */])() && logger.log("Integration installed: " + integration.name);
}
/**
...
var baseclient_BaseClient = /** @class */ (function () {
    ...
    BaseClient.prototype.captureException = function (exception, hint, scope) {
        ...
        if (checkOrSetAlreadyCaught(exception)) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.log(ALREADY_SEEN_ERROR);
            return;
        }
    ...
    BaseClient.prototype.captureSession = function (session) {
        if (!this._isEnabled()) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('SDK not enabled, will not capture session.');
            return;
        }
        if (!(typeof session.release === 'string')) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Discarded session because of missing or non-string release');
        }
        else {
    ...
    BaseClient.prototype.getIntegration = function (integration) {
        try {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn("Cannot retrieve integration " + integration.id + " from the current Client");
            return null;
        }
    };
    ...
    BaseClient.prototype._updateSessionFromEvent = function (session, event) {
        ...
        if (exceptions) {
            errored = true;
            try {
                for (var exceptions_1 = core_node_modules_tslib_tslib_es6_values(exceptions), exceptions_1_1 = exceptions_1.next(); !exceptions_1_1.done; exceptions_1_1 = exceptions_1.next()) {
        ...
        if (shouldUpdateAndSend) {
            session.update(core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({}, (crashed && { status: 'crashed' })), { errors: session.errors || Number(errored || crashed) }));
    ...
    BaseClient.prototype._prepareEvent = function (event, scope, hint) {
        ...
        var prepared = core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({}, event), { event_id: event.event_id || (hint && hint.event_id ? hint.event_id : uuid4()), timestamp: event.timestamp || Object(time["a" /* dateTimestampInSeconds */])() });
        ...
        return result.then(function (evt) {
            if (evt) {
                ...
                evt.sdkProcessingMetadata = core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({}, evt.sdkProcessingMetadata), { normalizeDepth: normalize(normalizeDepth) });
            }
    ...
    BaseClient.prototype._normalizeEvent = function (event, depth, maxBreadth) {
        ...
        normalized.sdkProcessingMetadata = core_node_modules_tslib_tslib_es6_assign(core_node_modules_tslib_tslib_es6_assign({}, normalized.sdkProcessingMetadata), { baseClientNormalized: true });
        return normalized;
    };
    /**
    ...
    BaseClient.prototype._captureEvent = function (event, hint, scope) {
        return this._processEvent(event, hint, scope).then(function (finalEvent) {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.error(reason);
            return undefined;
        });
    };
    /**
    ...
    BaseClient.prototype._processEvent = function (event, hint, scope) {
        ...
        if (!this._isEnabled()) {
            return rejectedSyncPromise(new error_SentryError('SDK not enabled, will not capture event.'));
        }
        ...
        if (!isTransaction && typeof sampleRate === 'number' && Math.random() > sampleRate) {
            ...
            return rejectedSyncPromise(new error_SentryError("Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")"));
        }
...
var client_NodeClient = /** @class */ (function (_super) {
    ...
    NodeClient.prototype.initSessionFlusher = function () {
        ...
        if (!release) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Cannot initialise an instance of SessionFlusher if no release is provided!');
        }
        else {
    ...
    NodeClient.prototype._captureRequestSession = function () {
        if (!this._sessionFlusher) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Discarded request mode session because autoSessionTracking option was disabled');
        }
        else {
...
function _mergeOptions(internalOptions, clientOptions) {
    ...
    return {
        allowUrls: core_node_modules_tslib_tslib_es6_spread((internalOptions.whitelistUrls || []), (internalOptions.allowUrls || []), (clientOptions.whitelistUrls || []), (clientOptions.allowUrls || [])),
        denyUrls: core_node_modules_tslib_tslib_es6_spread((internalOptions.blacklistUrls || []), (internalOptions.denyUrls || []), (clientOptions.blacklistUrls || []), (clientOptions.denyUrls || [])),
        ignoreErrors: core_node_modules_tslib_tslib_es6_spread((internalOptions.ignoreErrors || []), (clientOptions.ignoreErrors || []), DEFAULT_IGNORE_ERRORS),
...
function _getPossibleEventMessages(event) {
    ...
    if (event.exception) {
        try {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.error("Cannot extract message for event " + getEventDescription(event));
            return [];
        }
    }
    return [];
...
function _getEventFilterUrl(event) {
    try {
        ...
        Object(esm_env["b" /* isDebugBuild */])() && logger.error("Cannot extract url for event " + getEventDescription(event));
        return null;
    }
}
...
var external_domain_ = __webpack_require__(22);

// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/enums.js
...
function isSentryRequest(url) {
    var _a;
    var dsn = (_a = hub_getCurrentHub().getClient()) === null || _a === void 0 ? void 0 : _a.getDsn();
...
var http_NODE_VERSION = parseSemver(process.versions.node);
...
function logAndExitProcess(error) {
    ...
    if (client === undefined) {
        Object(esm_env["b" /* isDebugBuild */])() && logger.warn('No NodeClient was defined, we are exiting the process now.');
    ...
    forget(client.close(timeout).then(function (result) {
        if (!result) {
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('We reached the timeout for emptying the request buffer, still exiting now!');
        }
        global.process.exit(1);
    }));
}
    ...
    Object.defineProperty(ContextLines.prototype, "_contextLines", {
        ...
        get: function () {
            ...
            if (this._options.frameContextLines === undefined) {
                var initOptions = (_a = hub_getCurrentHub().getClient()) === null || _a === void 0 ? void 0 : _a.getOptions();
                // eslint-disable-next-line deprecation/deprecation
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        contextLines = hub_getCurrentHub().getIntegration(contextlines_ContextLines);
...
function init(options) {
    ...
    if (external_domain_["active"]) {
        setHubOnCarrier(carrier, hub_getCurrentHub());
    }
...
function sdk_flush(timeout) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Cannot flush events. No client defined.');
...
function sdk_close(timeout) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            Object(esm_env["b" /* isDebugBuild */])() && logger.warn('Cannot flush events and disable SDK. No client defined.');
            return [2 /*return*/, Promise.resolve(false)];
        });
    });
}
...
// CONCATENATED MODULE: /Users/offirmo/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/tracing.js
    ...
    return function sentryRequestMiddleware(req, res, next) {
        if (options && options.flushTimeout && options.flushTimeout > 0) {
            ...
            res.end = function (chunk, encoding, cb) {
                var _this = this;
                void sdk_flush(options.flushTimeout)
                    .then(function () {
                    _end_1.call(_this, chunk, encoding, cb);
                })
                    .then(null, function (e) {
                    Object(esm_env["b" /* isDebugBuild */])() && logger.error(e);
                    _end_1.call(_this, chunk, encoding, cb);
                });
            };
        }
...
const json_stable_stringify_1 = tslib_1.__importDefault(__webpack_require__(78));

const timestamps_1 = __webpack_require__(23);

const soft_execution_context_1 = __webpack_require__(24);

const state_utils_1 = __webpack_require__(29);

const api_interface_1 = __webpack_require__(49);

const async_utils_1 = __webpack_require__(191);
...
const soft_execution_context_node_1 = __webpack_require__(178);

const consts_1 = __webpack_require__(25);

const channel_1 = __webpack_require__(39);

const logger_1 = tslib_1.__importDefault(__webpack_require__(179)); /////////////////////
...
function _force_set_level_of_uda_default_logger(suggestedLevel) {
  ...
  if (!logger.setLevel) {
    try {
      ...
      } catch {//const { getLogger } = require('../../universal-debug-api-node')
...
const universal_debug_api_node_1 = __webpack_require__(42);
...
exports.parse = __webpack_require__(181);
exports.stringify = __webpack_require__(182);
...
const colorConvert = __webpack_require__(186);
...
var conversions = __webpack_require__(105);
...
const typescript_string_enums_1 = __webpack_require__(5);
...
const requestIdleCallback = ((_b = Object(src_es2019["a" /* getGlobalThis */])().requestIdleCallback) === null || _b === void 0 ? void 0 : _b.bind(Object(src_es2019["a" /* getGlobalThis */])()) // yes, the bind is needed
) || function requestIdleCallbackPonyFill(callback, {
...
/* harmony import */ var _generate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);
...
var emittery = __webpack_require__(132);
...
/* harmony import */ var _util_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62);
...
/* harmony import */ var _util_normalize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "is_WithSchemaVersion", function() { return /* reexport */ type_guards["i" /* is_WithSchemaVersion */]; });
__webpack_require__.d(__webpack_exports__, "is_WithRevision", function() { return /* reexport */ type_guards["h" /* is_WithRevision */]; });
__webpack_require__.d(__webpack_exports__, "is_WithTimestamp", function() { return /* reexport */ type_guards["j" /* is_WithTimestamp */]; });
__webpack_require__.d(__webpack_exports__, "is_WithLastUserInvestmentTimestamp", function() { return /* reexport */ type_guards["g" /* is_WithLastUserInvestmentTimestamp */]; });
...
__webpack_require__.d(__webpack_exports__, "is_revisioned", function() { return /* reexport */ type_guards["k" /* is_revisioned */]; });
__webpack_require__.d(__webpack_exports__, "is_time_stamped", function() { return /* reexport */ type_guards["l" /* is_time_stamped */]; });
...
__webpack_require__.d(__webpack_exports__, "get_schema_version", function() { return /* reexport */ selectors["f" /* get_schema_version */]; });
__webpack_require__.d(__webpack_exports__, "get_schema_version_loose", function() { return /* reexport */ selectors["g" /* get_schema_version_loose */]; });
__webpack_require__.d(__webpack_exports__, "get_revision", function() { return /* reexport */ selectors["d" /* get_revision */]; });
__webpack_require__.d(__webpack_exports__, "get_revision_loose", function() { return /* reexport */ selectors["e" /* get_revision_loose */]; });
__webpack_require__.d(__webpack_exports__, "get_timestamp", function() { return /* reexport */ selectors["h" /* get_timestamp */]; });
__webpack_require__.d(__webpack_exports__, "get_timestamp_loose", function() { return /* reexport */ selectors["i" /* get_timestamp_loose */]; });
__webpack_require__.d(__webpack_exports__, "get_last_user_activity_timestamp", function() { return /* reexport */ selectors["b" /* get_last_user_activity_timestamp */]; });
__webpack_require__.d(__webpack_exports__, "get_last_user_activity_timestamp_loose", function() { return /* reexport */ selectors["c" /* get_last_user_activity_timestamp_loose */]; });
__webpack_require__.d(__webpack_exports__, "get_base_loose", function() { return /* reexport */ selectors["a" /* get_base_loose */]; });
__webpack_require__.d(__webpack_exports__, "fluid_select", function() { return /* reexport */ selectors_fluid["a" /* fluid_select */]; });
__webpack_require__.d(__webpack_exports__, "is_deep_equal", function() { return /* reexport */ dequal; });
__webpack_require__.d(__webpack_exports__, "SemanticDifference", function() { return /* reexport */ SemanticDifference; });
__webpack_require__.d(__webpack_exports__, "s_max", function() { return /* reexport */ s_max; });
__webpack_require__.d(__webpack_exports__, "get_json_difference", function() { return /* reexport */ get_json_difference; });
__webpack_require__.d(__webpack_exports__, "UNCLEAR_get_difference__full", function() { return /* reexport */ UNCLEAR_get_difference__full; });
__webpack_require__.d(__webpack_exports__, "UNCLEAR_get_difference", function() { return /* reexport */ UNCLEAR_get_difference; });
...
var selectors = __webpack_require__(4);
...
var selectors_fluid = __webpack_require__(104);
...
var memoize_one_esm = __webpack_require__(100);
...
const jsondiffpatch = __webpack_require__(183);
...
const SemanticDifference = Object(dist["Enum"])('none', 'time', // time of last meaningful activity, not T-State. Important to discriminate forks.
'minor', 'major');
function s_max(a, b) {
...
const _get_advanced_json_differ = Object(memoize_one_esm["default"])(() => {
...
function UNCLEAR_get_difference__full(a, b) {
  ...
  const schema_version__a = Object(selectors["g" /* get_schema_version_loose */])(a);
  const schema_version__b = Object(selectors["g" /* get_schema_version_loose */])(b);
  ...
  if (is_root__a && a.ⵙapp_id && b.ⵙapp_id) {
    Object(tiny_invariant_esm["default"])(a.ⵙapp_id === b.ⵙapp_id, `UNCLEAR_get_difference() states should be in the same universe!`);
  }

  const revision__a = Object(selectors["e" /* get_revision_loose */])(a);
  const revision__b = Object(selectors["e" /* get_revision_loose */])(b);
  if (revision__a !== revision__b) return {
    type: SemanticDifference.minor,
    direction: revision__a - revision__b
  };
  const activity_tms__a = Object(selectors["c" /* get_last_user_activity_timestamp_loose */])(a);
  const activity_tms__b = Object(selectors["c" /* get_last_user_activity_timestamp_loose */])(b);
  if (activity_tms__a !== activity_tms__b) return {
    type: SemanticDifference.minor,
    direction: activity_tms__a - activity_tms__b
  }; // last resort if state is/has a T_state

  const t_tms__a = Object(selectors["i" /* get_timestamp_loose */])(a);
  const t_tms__b = Object(selectors["i" /* get_timestamp_loose */])(b);
...
var migration = __webpack_require__(106);
...
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20);
/**
 * NOTE: In order to avoid circular dependencies, if you add a function to this module and it needs to print something,
 * you must either a) use `console.log` rather than the logger, or b) put your function elsewhere.
 */
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return get_schema_version; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return get_schema_version_loose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return get_revision; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return get_revision_loose; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return get_timestamp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return get_timestamp_loose; });
...
function get_schema_version(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_WithSchemaVersion */ "i"])(s)) {
    const {
      schema_version
    } = s;
  ...
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_UTBundle */ "f"])(s)) {
    Object(tiny_invariant__WEBPACK_IMPORTED_MODULE_0__["default"])(get_schema_version(s[0]) === get_schema_version(s[1]), 'get_schema_version() U & T versions should match inside a bundle!');
    return get_schema_version(s[0]);
  }

  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_RootState */ "c"])(s)) {
    Object(tiny_invariant__WEBPACK_IMPORTED_MODULE_0__["default"])(get_schema_version(s.u_state) === get_schema_version(s.t_state), 'get_schema_version() U & T versions should match inside a root!');
...
function get_schema_version_loose(s) {
  ...
  if (Array.isArray(s)) {
    ...
    if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* has_versioned_schema */ "a"])(maybe_legacy_bundle[0])) {
      return get_schema_version(maybe_legacy_bundle[0]);
    }
  }

  if (s && typeof s === 'object') {
    const maybe_legacy_root_state = s;
...
function get_revision(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_WithRevision */ "h"])(s)) {
    const {
      revision
    } = s;
    Object(tiny_invariant__WEBPACK_IMPORTED_MODULE_0__["default"])(Number.isSafeInteger(revision), 'get_revision() should be a safeInteger');
    return revision;
  }
...
function get_revision_loose(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_revisioned */ "k"])(s)) return get_revision(s); // specific fallbacks:

  if (Array.isArray(s)) {
    const maybe_legacy_bundle = s;

    if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_revisioned */ "k"])(maybe_legacy_bundle[0])) {
...
function get_timestamp(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_WithTimestamp */ "j"])(s)) {
    const {
      timestamp_ms
    } = s;
...
function get_timestamp_loose(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_time_stamped */ "l"])(s)) return get_timestamp(s); // specific fallbacks:
  // loose bundles

  if (Array.isArray(s) && Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_time_stamped */ "l"])(s[1])) return get_timestamp(s[1]); // final fallback

  return 0;
}
function get_last_user_activity_timestamp(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_WithLastUserInvestmentTimestamp */ "g"])(s)) {
    const {
      last_user_investment_tms
    } = s;
    Object(tiny_invariant__WEBPACK_IMPORTED_MODULE_0__["default"])(Number.isSafeInteger(last_user_investment_tms), 'get_last_user_activity_timestamp() safeInteger');
...
function get_last_user_activity_timestamp_loose(s) {
  if (Object(_type_guards__WEBPACK_IMPORTED_MODULE_1__[/* is_WithLastUserInvestmentTimestamp */ "g"])(s)) return get_last_user_activity_timestamp(s); // final fallback
...
const DEFAULTS_PRETTIFY_OPTIONS = {
  ...
  prettify_symbol: (s, st) => {
    ...
    try {
      ...
      return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/ps]`);
    }
  },
  // objects
  ...
  prettify_property_name: (p, st) => {
    ...
    try {
      ...
      return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/ppn]`);
    }
  },
    ...
    try {
      ...
      if (o.should_recognize_globals) {
        try {
          ...
          return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/po.g]`);
        }
      }
      ...
      if (!skip_constructor) {
        try {
          ...
          return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/po.c]`);
        }
      }
      ...
      return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/po]`);
    }
  },
  ...
  prettify_any(any, st) {
    ...
    try {
      ...
      return o.stylize_error(`[error prettifying:${err === null || err === void 0 ? void 0 : err.message}/pa]`);
    }
  }
...
function prettify_any(js, options = {}) {
  try {
    ...
    return `[error prettifying:${err === null || err === void 0 ? void 0 : err.message}]`;
  }
}
...
const error_utils_1 = __webpack_require__(26);
...
const runner_1 = __webpack_require__(176);

const require_http_method_1 = __webpack_require__(190); ////////////////////////////////////
...
const handler = (event, badly_typed_context) => {
  return (0, runner_1.use_middlewares_with_error_safety_net)(event, badly_typed_context, [(0, require_http_method_1.require_http_method)([require_http_method_1.HttpMethod.GET]), _handler]);
};
...
const agent_1 = __importDefault(__webpack_require__(137));
  ...
  try {
    ...
    const true_err = should_recreate ? (() => {
      const true_err = (() => {
        ...
        let message = (err_like === null || err_like === void 0 ? void 0 : err_like.message // even no error shape may have a message prop
        ...
        try {
          ...
          const wanted_constructor = ((_b = (_a = current_prototype === null || current_prototype === void 0 ? void 0 : current_prototype.constructor) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.endsWith('Error')) ? current_prototype.constructor : Error; // https://stackoverflow.com/questions/1606797/use-of-apply-with-new-operator-is-this-possible
...
const ansiStyles = __webpack_require__(185);
const stdoutColor = __webpack_require__(74).stdout;

const template = __webpack_require__(189);
...
var json = typeof JSON !== 'undefined' ? JSON : __webpack_require__(180);
