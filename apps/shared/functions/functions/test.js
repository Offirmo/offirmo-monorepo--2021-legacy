...
const sec_1 = __webpack_require__(106);

const utils_1 = __webpack_require__(25);

const handler = async (event, badly_typed_context) => {
  return new Promise((resolve, reject) => {
    sec_1.SEC.emitter.on('final-error', ({
      SEC,
      err
    }) => {
      // TODO raven
      if (!err.statusCode && !err.res) reject(err);
    ...
    return sec_1.SEC.xPromiseTryCatch('/test', ({
      SEC,
      logger
    }) => {
      ...
      setTimeout(() => {
        throw utils_1.create_error('In uncaught async!', {
          statusCode: 555
        });
      }, 100);
    });
...
const soft_execution_context_1 = __webpack_require__(90);

const soft_execution_context_node_1 = __webpack_require__(107);

const consts_1 = __webpack_require__(24);

const channel_1 = __webpack_require__(54);

const logger_1 = tslib_1.__importDefault(__webpack_require__(108));

const sentry_1 = __webpack_require__(109); /////////////////////
...
SEC.emitter.on('final-error', function onError({
  ...
  sentry_1.on_error(err); //console.log({err})
...
const {
  getRootSEC
} = __webpack_require__(90); // TODO protect from double install
...
const practical_logger_core_1 = __webpack_require__(232);

const consts_1 = __webpack_require__(24); /////////////////////////////////////////////////


const logger = practical_logger_core_1.createLogger({
  name: consts_1.APP,
  suggestedLevel: 'error'
});
logger.notice(`Hello from "${consts_1.APP}", vTODO! Logger up with level = "${logger.getLevel()}".`);
...
const Sentry = __webpack_require__(231); //Sentry.captureException(err)
...
Sentry.configureScope(scope => {
  scope.setExtra('CHANNEL', channel_1.CHANNEL); // TODO node version etc. ?
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return isThenable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return isSyntheticEvent; });
/**
...
module.exports = function () {
    ...
    var ES6Promise = __webpack_require__(114);
...
module.exports = function () {
    ...
    return __webpack_require__(115).Promise;
}();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return urlEncode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return normalizeToSize; });
...
function serializeValue(value) {
    ...
    return Object(is["c" /* isPrimitive */])(normalized) ? normalized : type;
}
/**
 * normalizeValue()
 *
...
function normalizeValue(value, key) {
    ...
    if (Object(is["f" /* isSyntheticEvent */])(value)) {
...
function walk(key, value, depth, memo) {
    ...
    if (Object(is["c" /* isPrimitive */])(normalized)) {
        return normalized;
    }
    // Create source that we will use for next itterations, either objectified error object (Error type with extracted keys:value pairs) or the input itself
    var source = (Object(is["a" /* isError */])(value) ? objectifyError(value) : value);
...
var esm_span = __webpack_require__(92);

// EXTERNAL MODULE: /Users/yjutard/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/logger.js
var logger = __webpack_require__(234);

// EXTERNAL MODULE: /Users/yjutard/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/is.js
var is = __webpack_require__(11);

// CONCATENATED MODULE: /Users/yjutard/work/src/off/offirmo-monorepo/node_modules/@sentry/utils/esm/string.js
...
function isMatchingPattern(value, pattern) {
    if (Object(is["d" /* isRegExp */])(pattern)) {
...
var syncpromise = __webpack_require__(233);
...
var baseclient_BaseClient = /** @class */ (function () {
    ...
    BaseClient.prototype.captureMessage = function (message, level, hint, scope) {
        ...
        var eventId = hint && hint.event_id;
        this._processing = true;
        var promisedEvent = Object(is["c" /* isPrimitive */])(message)
    ...
    BaseClient.prototype._prepareEvent = function (event, scope, hint) {
        ...
        if (prepared.event_id === undefined) {
            prepared.event_id = Object(misc["f" /* uuid4 */])();
        }
        ...
        return new syncpromise["a" /* SyncPromise */](function (resolve, reject) {
            _this._prepareEvent(event, scope, hint).then(function (prepared) {
                ...
                try {
                    ...
                    else if (Object(is["g" /* isThenable */])(beforeSendResult)) {
...
var api_API = /** @class */ (function () {
    ...
    API.prototype.getStoreEndpointWithUrlEncodedAuth = function () {
        ...
        return this.getStoreEndpoint() + "?" + Object(object["d" /* urlEncode */])(auth);
    };
...
var promisebuffer_PromiseBuffer = /** @class */ (function () {
    ...
    PromiseBuffer.prototype.add = function (task) {
        var _this = this;
        if (!this.isReady()) {
            return Promise.reject(new error_SentryError('Not adding Promise due to buffer limit reached.'));
        }
...
var https_proxy_agent = __webpack_require__(34);
...
var external_https_ = __webpack_require__(35);
...
var backend_NodeBackend = /** @class */ (function (_super) {
    ...
    NodeBackend.prototype.eventFromException = function (exception, hint) {
        ...
        if (!Object(is["a" /* isError */])(exception)) {
            if (Object(is["b" /* isPlainObject */])(exception)) {
                // This will allow us to group events based on top-level keys
                // which is much better than creating new group when any key/value change
                var keys = Object.keys(exception).sort();
                var message = "Non-Error exception captured with keys: " + keysToEventMessage(keys);
                Object(esm_hub["b" /* getCurrentHub */])().configureScope(function (scope) {
                    scope.setExtra('__serialized__', Object(object["c" /* normalizeToSize */])(exception));
                });
        ...
        return new syncpromise["a" /* SyncPromise */](function (resolve, reject) {
            return parseError(ex, _this._options)
                .then(function (event) {
                Object(misc["a" /* addExceptionTypeValue */])(event, undefined, undefined, mechanism);
...
var console_Console = /** @class */ (function () {
    ...
    Console.prototype.setupOnce = function () {
        var nativeModule = __webpack_require__(56);
        Object(object["a" /* fill */])(nativeModule, '_load', loadWrapper(nativeModule));
...
function consoleWrapper(originalModule) {
    return function (level) {
        ...
        Object(object["a" /* fill */])(originalModule, level, function (originalConsoleLevel) {
            var sentryLevel;
            switch (level) {
                case 'debug':
...
var http_Http = /** @class */ (function () {
    ...
    Http.prototype.setupOnce = function () {
        var nativeModule = __webpack_require__(56);
        Object(object["a" /* fill */])(nativeModule, '_load', http_loadWrapper(nativeModule));
...
function http_loadWrapper(nativeModule) {
    ...
    return function (originalLoad) {
        return function (moduleId) {
            ...
            Object(object["a" /* fill */])(clientRequest.prototype, 'emit', emitWrapper);
            Object(object["a" /* fill */])(originalModule, 'ClientRequest', function () {
            ...
            Object(object["a" /* fill */])(originalModule, 'request', function () {
                return function (options, callback) {
                    return new originalModule.ClientRequest(options, callback);
                };
            });
            Object(object["a" /* fill */])(originalModule, 'get', function () {
                return function (options, callback) {
    ...
    attributes.forEach(function (key) {
        switch (key) {
            ...
            case 'data':
                ...
                if (data && !Object(is["e" /* isString */])(data)) {
                    // Make sure the request body is a string
                    data = JSON.stringify(Object(object["b" /* normalize */])(data));
                }
                request.data = data;
                break;
            default:
    ...
    return function sentryErrorMiddleware(error, _req, _res, next) {
        ...
        if (shouldHandleError(error)) {
            withScope(function (scope) {
                if (_req.headers && Object(is["e" /* isString */])(_req.headers['sentry-trace'])) {
    ...
    LinkedErrors.prototype.walkErrorTree = function (error, key, stack) {
        ...
        return new syncpromise["a" /* SyncPromise */](function (resolve) {
            getExceptionFromError(error[key]).then(function (exception) {
                _this.walkErrorTree(error[key], key, tslib_es6["__spread"]([exception], stack)).then(resolve);
            });
        });
    };
    /**
...
function init(options) {
    ...
    if (options.release === undefined) {
        var global_1 = Object(misc["e" /* getGlobalObject */])();
...
// CONCATENATED MODULE: /Users/yjutard/work/src/off/offirmo-monorepo/1-foundation/practical-logger-core/dist/src.es2019/index.js
/* concated harmony reexport createLogger */__webpack_require__.d(__webpack_exports__, "createLogger", function() { return create; });
/* concated harmony reexport ALL_LOG_LEVELS */__webpack_require__.d(__webpack_exports__, "ALL_LOG_LEVELS", function() { return ALL_LOG_LEVELS; });
/* concated harmony reexport LOG_LEVEL_TO_INTEGER */__webpack_require__.d(__webpack_exports__, "LOG_LEVEL_TO_INTEGER", function() { return LOG_LEVEL_TO_INTEGER; });
/* concated harmony reexport LOG_LEVEL_TO_HUMAN */__webpack_require__.d(__webpack_exports__, "LOG_LEVEL_TO_HUMAN", function() { return LOG_LEVEL_TO_HUMAN; });
...
/* concated harmony reexport checkLevel */__webpack_require__.d(__webpack_exports__, "checkLevel", function() { return checkLevel; });
/* concated harmony reexport looksLikeAnError */__webpack_require__.d(__webpack_exports__, "looksLikeAnError", function() { return looksLikeAnError; });
/* concated harmony reexport normalizeArguments */__webpack_require__.d(__webpack_exports__, "normalizeArguments", function() { return normalizeArguments; });
...
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
...
var SyncPromise = /** @class */ (function () {
    function SyncPromise(callback) {
        ...
        this._setResult = function (value, state) {
            ...
            if (Object(_is__WEBPACK_IMPORTED_MODULE_0__[/* isThenable */ "g"])(value)) {
...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.log = function () {
        ...
        Object(_misc__WEBPACK_IMPORTED_MODULE_0__[/* consoleSandbox */ "b"])(function () {
...
/* harmony import */ var _sentry_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(234);
/* harmony import */ var _scope__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37);
...
var Hub = /** @class */ (function () {
    ...
    Hub.prototype.captureException = function (exception, hint) {
        var eventId = (this._lastEventId = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__[/* uuid4 */ "f"])());
        var finalHint = hint;
    ...
    Hub.prototype.addBreadcrumb = function (breadcrumb, hint) {
        ...
        var finalBreadcrumb = beforeBreadcrumb
            ? Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__[/* consoleSandbox */ "b"])(function () { return beforeBreadcrumb(mergedBreadcrumb, hint); })
            : mergedBreadcrumb;
...
function getCurrentHub() {
    ...
    try {
        ...
        var domain = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__[/* dynamicRequire */ "c"])(module, 'domain');
...
var tls = __webpack_require__(39);
var url = __webpack_require__(15);
var Agent = __webpack_require__(111);
var inherits = __webpack_require__(4).inherits;
var debug = __webpack_require__(116)('https-proxy-agent');
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _sentry_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(233);
...
/* harmony import */ var _span__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(92);
...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype._notifyEventProcessors = function (processors, event, hint, index) {
        ...
        return new _sentry_utils__WEBPACK_IMPORTED_MODULE_1__[/* SyncPromise */ "a"](function (resolve, reject) {
            ...
            if (event === null || typeof processor !== 'function') {
                ...
                if (Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__[/* isThenable */ "g"])(result)) {
                    result
    ...
    Scope.prototype.setUser = function (user) {
        this._user = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(user);
    ...
    Scope.prototype.setTags = function (tags) {
        this._tags = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._tags, Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(tags));
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setTag = function (key, value) {
        var _a;
        this._tags = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._tags, (_a = {}, _a[key] = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(value), _a));
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setExtras = function (extra) {
        this._extra = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._extra, Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(extra));
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setExtra = function (key, extra) {
        var _a;
        this._extra = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._extra, (_a = {}, _a[key] = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(extra), _a));
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setFingerprint = function (fingerprint) {
        this._fingerprint = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(fingerprint);
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setLevel = function (level) {
        this._level = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(level);
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.setContext = function (name, context) {
        this._context[name] = context ? Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(context) : undefined;
        this._notifyScopeListeners();
        return this;
    };
    /**
    ...
    Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
        ...
        this._breadcrumbs =
            maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0
                ? tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this._breadcrumbs, [Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(mergedBreadcrumb)]).slice(-maxBreadcrumbs)
                : tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this._breadcrumbs, [Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__[/* normalize */ "b"])(mergedBreadcrumb)]);
        this._notifyScopeListeners();
        return this;
    };
    /**
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(118);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return dynamicRequire; });
/* unused harmony export isNodeEnv */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getGlobalObject; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addExceptionTypeValue; });
/**
...
var emittery = __webpack_require__(91);
...
var field_set = __webpack_require__(22);
...
function decorateWithDetectedEnv(SEC) {
  let ENV = (() => {
    try {
      if (typeof NODE_ENV === 'string') return NODE_ENV;
...
function createSEC(args = {}) {
  ...
  PLUGINS.forEach(PLUGIN => {
    state = activate_plugin(state, PLUGIN, args);
  });
...
var Span = /** @class */ (function () {
    function Span(_traceId, _spanId, _sampled, _parent) {
        if (_traceId === void 0) { _traceId = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_0__[/* uuid4 */ "f"])(); }
        if (_spanId === void 0) { _spanId = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_0__[/* uuid4 */ "f"])().substring(16); }
