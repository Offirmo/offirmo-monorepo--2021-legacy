...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"FKRf":[function(require,module,exports) {
...
var logger = universal_debug_api_placeholder_1.getLogger({
  suggestedLevel: 'warn'
});
logger.log('hello from logger!');
var demoLogger = universal_debug_api_placeholder_1.getLogger({
  name: 'Demo',
  suggestedLevel: 'silly'
});
...
//# sourceMappingURL=src.42fd2ecf.js.map