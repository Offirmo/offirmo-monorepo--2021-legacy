...
var sink = function (payload) {
  ...
  if (name) {
    line = (0, common_2.add_styled_string)(line, name + " \u203A ", common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL);
  }
...
var sink = function (payload) {
  ...
  if (name) {
    line = (0, common_2.add_styled_string)(line, name + " \u203A ", common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL, MESSAGE_FONT_SIZE_STYLE);
  }
...
//# sourceMappingURL=src.ae64a0b6.js.map