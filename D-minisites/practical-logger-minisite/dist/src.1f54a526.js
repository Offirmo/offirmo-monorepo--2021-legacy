...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"lCdy":[function(require,module,exports) {
"use strict";
...
},{}],"yYcW":[function(require,module,exports) {
...
},{"./consts":"uPNs","./normalize-args":"Myj7"}],"K18v":[function(require,module,exports) {
"use strict"; //////////// Public interface (for logger usage) ////////////

Object.defineProperty(exports, "__esModule", {
  value: true
});
},{}],"M14Q":[function(require,module,exports) {
"use strict";
...
},{"./core":"bulS","@offirmo/practical-logger-types":"K18v","./consts":"uPNs","./normalize-args":"Myj7"}],"ZDBk":[function(require,module,exports) {
"use strict";
...
},{"@offirmo/practical-logger-core":"M14Q"}],"vTLE":[function(require,module,exports) {
"use strict";
...
function add_styled_string(line, chunk) {
  ...
  return __spreadArray(__spreadArray([existing_chunks + '%c' + chunk], existing_chunks_styles, true), [styles.join(';') + ';'], false);
}
...
},{}],"b2eI":[function(require,module,exports) {
"use strict";
...
var sink = function (payload) {
  ...
  if (!has_details_indicator(console_method_name)) {
    line = (0, common_2.add_styled_string)(line, '▷', common_2.LEVEL_TO_COLOR_STYLE[level], 'font-size: 8px', common_2.FONT_FAMILY_BETTER_PROPORTIONAL, 'margin-left: .35em', 'margin-right: .5em');
  }

  line = (0, common_2.add_styled_string)(line, '[', common_2.LEVEL_TO_COLOR_STYLE[level], HEADER_FONT_SIZE_STYLE, common_2.FONT_FAMILY_BETTER_PROPORTIONAL);
  line = (0, common_2.add_styled_string)(line, (0, common_1.to_uniform_level)(level), common_2.LEVEL_TO_COLOR_STYLE[level], HEADER_FONT_SIZE_STYLE, common_2.FONT_FAMILY_BETTER_MONOSPACE);
  line = (0, common_2.add_styled_string)(line, '] ', common_2.LEVEL_TO_COLOR_STYLE[level], HEADER_FONT_SIZE_STYLE, common_2.FONT_FAMILY_BETTER_PROPORTIONAL);
  line = (0, common_2.add_styled_string)(line, '', 'font-size: unset');

  if (name) {
    line = (0, common_2.add_styled_string)(line, "".concat(name, " \u203A "), common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL);
  }

  line = (0, common_2.add_styled_string)(line, msg, common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL);
  console_method.apply(void 0, (0, common_2.build_args)(line, payload));
};

exports.sink = sink;
exports.default = exports.sink;
},{"../common":"ZDBk","./common":"vTLE"}],"NJKU":[function(require,module,exports) {
"use strict";
...
var sink = function (payload) {
  ...
  if (!has_details_indicator(console_method_name)) {
    line = (0, common_2.add_styled_string)(line, '▷', common_2.LEVEL_TO_COLOR_STYLE[level], 'font-size: 8px', common_2.FONT_FAMILY_BETTER_PROPORTIONAL, 'margin-left: .1em', 'margin-right: .2em');
  }
  ...
  if (name) {
    line = (0, common_2.add_styled_string)(line, "".concat(name, " \u203A "), common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL, MESSAGE_FONT_SIZE_STYLE);
  }

  line = (0, common_2.add_styled_string)(line, msg, common_2.LEVEL_TO_COLOR_STYLE[level], common_2.FONT_FAMILY_BETTER_PROPORTIONAL, MESSAGE_FONT_SIZE_STYLE);
  console_method.apply(void 0, (0, common_2.build_args)(line, payload));
};

exports.sink = sink;
exports.default = exports.sink;
},{"../common":"ZDBk","./common":"vTLE"}],"uFbs":[function(require,module,exports) {
"use strict";
...
var sink = function (payload) {
  ...
  if (!has_details_indicator(console_method_name, details)) {
    line = (0, common_2.add_styled_string)(line, '▷', common_2.LEVEL_TO_COLOR_STYLE[level], 'font-size: 10px', common_2.FONT_FAMILY_BETTER_PROPORTIONAL, 'margin-left: .15em', 'margin-right: .4em');
  }
...
exports.sink = sink;
exports.default = exports.sink;
},{"../common":"ZDBk","./common":"vTLE"}],"cboU":[function(require,module,exports) {
"use strict";
...
function create(options) {
  ...
  return function (payload) {
    ...
    var console_method_name = common_1.LEVEL_TO_CONSOLE_METHOD[level];
    var console_method = console[console_method_name];
    var line = ['[', (0, common_1.to_uniform_level)(level), '] '];

    if (name) {
      line.push("".concat(name, " \u203A "));
    }
...
},{"./common":"ZDBk"}],"medf":[function(require,module,exports) {
"use strict";
...
function create(options) {
  ...
  if (options.useCss === false) return (0, no_css_1.default)(options);
  ...
  switch (options.explicitBrowser || quick_detect_browser()) {
    ...
    default:
      return (0, no_css_1.default)(options);
  }
}

exports.create = create;
},{"./advanced/firefox":"b2eI","./advanced/chromium":"NJKU","./advanced/safari":"uFbs","./no-css":"cboU"}],"O38w":[function(require,module,exports) {
...
function install(_a) {
  ...
  function better_output(original_method, uncollapse) {
    ...
    if (DEBUG) original_method('>>> before output', {
      depth: group_invocations.length
    }, "\"".concat(p[0], "\"")); // lazily create groups
  ...
  console.assert = function (assertion) {
    ...
    if (assertion) {// do nothing
      ...
      better_output.apply(void 0, __spreadArray([ORIGINAL_METHODS.assert, true, assertion], args, false));
    }
  };
...
},{}],"NIpY":[function(require,module,exports) {
"use strict";
...
var _install_groups_or_not_once_for_all = (0, tiny_singleton_1.default)(function (active) {
  if (active) (0, practical_logger_1.default)();
});
...
function createLogger(p) {
  ...
  var sink = ((_b = p.sinkOptions) === null || _b === void 0 ? void 0 : _b.sink) || (0, sinks_1.create)(p.sinkOptions);
  var group = ORIGINAL_CONSOLE.group,
      groupCollapsed = ORIGINAL_CONSOLE.groupCollapsed,
      groupEnd = ORIGINAL_CONSOLE.groupEnd;
  return __assign(__assign({}, (0, practical_logger_core_1.createLogger)(p, sink)), {
    group: group,
...
},{"@offirmo/tiny-singleton":"lCdy","@offirmo/practical-logger-core":"M14Q","./sinks":"medf","./better-console-groups/practical-logger":"O38w","@offirmo/practical-logger-types":"K18v"}],"plv1":[function(require,module,exports) {
const {
  ALL_LOG_LEVELS
} = require('..');
...
var logger = (0, practical_logger_browser_1.createLogger)({
  suggestedLevel: 'warn'
});
logger.log('hello from logger!');
var demoLogger = (0, practical_logger_browser_1.createLogger)({
  name: 'Demo',
  suggestedLevel: 'silly'
});
