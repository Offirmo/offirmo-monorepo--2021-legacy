"use strict";
const { LIB, INTERNAL_PROP, createCatcher, isomorphic: { isSEC, create: createCore, setRoot, getContext, } } = require('@offirmo/soft-execution-context');
...
export { isSEC, setRoot, getContext, node, };
