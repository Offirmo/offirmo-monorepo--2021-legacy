...
/////////////////////
import { InventorySlot, ItemQuality, generate_uuid, } from '@oh-my-rpg/definitions';
import * as MetaState from '@oh-my-rpg/state-meta';
import * as CharacterState from '@oh-my-rpg/state-character';
import { CharacterAttribute, increase_stat, rename, switch_class, } from '@oh-my-rpg/state-character';
import * as WalletState from '@oh-my-rpg/state-wallet';
import { Currency } from '@oh-my-rpg/state-wallet';
import * as InventoryState from '@oh-my-rpg/state-inventory';
import { get_item_in_slot, get_item_at_coordinates, } from '@oh-my-rpg/state-inventory';
import * as PRNGState from '@oh-my-rpg/state-prng';
import { get_prng, generate_random_seed, } from '@oh-my-rpg/state-prng';
import { create as create_weapon, enhance as enhance_weapon, MAX_ENHANCEMENT_LEVEL as MAX_WEAPON_ENHANCEMENT_LEVEL, DEMO_WEAPON_1, } from '@oh-my-rpg/logic-weapons';
...
import { create as create_monster, DEMO_MONSTER_01, } from '@oh-my-rpg/logic-monsters';
...
function play_good(state, explicit_adventure_archetype_hid) {
    ...
    if (gained.weapon_improvement) {
        gain_count++;
        let weapon_to_enhance = get_item_in_slot(state.inventory, InventorySlot.weapon);
    ...
    if (gained.armor_improvement) {
        gain_count++;
        const armor_to_enhance = get_item_in_slot(state.inventory, InventorySlot.armor);
...
/////////////////////
export { GainType, appraise_item_at_coordinates, create, reseed, play, equip_item, sell_item, rename_avatar, change_avatar_class, DEMO_ADVENTURE_01, DEMO_ADVENTURE_02, DEMO_ADVENTURE_03, DEMO_ADVENTURE_04, DEMO_STATE, OLDEST_LEGACY_STATE_FOR_TESTS, MIGRATION_HINTS_FOR_TESTS, };
/////////////////////
