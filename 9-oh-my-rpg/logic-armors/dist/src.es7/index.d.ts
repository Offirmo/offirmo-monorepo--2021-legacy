...
declare function compare_armors_by_strength(a: Readonly<Armor>, b: Readonly<Armor>): number;
...
export { ArmorPartType, Armor, MIN_ENHANCEMENT_LEVEL, MAX_ENHANCEMENT_LEVEL, MIN_STRENGTH, MAX_STRENGTH, create, generate_random_demo_armor, enhance, get_damage_reduction_interval, get_medium_damage_reduction, compare_armors_by_strength, i18n_messages, static_armor_data, DEMO_ARMOR_1, DEMO_ARMOR_2, };
