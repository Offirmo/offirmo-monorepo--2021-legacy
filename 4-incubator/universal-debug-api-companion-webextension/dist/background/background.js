...
},{"core-js/shim":"../../../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../../../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../../../node_modules/core-js/fn/regexp/escape.js"}],"background/background.js":[function(require,module,exports) {
"use strict";

require("babel-polyfill");

var LIB = '🧩 UWDT/bg';
console.log("[".concat(LIB, ".").concat(+Date.now(), "] Hello from background!"), {
  browser: window.browser && window.browser.runtime,
  chrome: chrome
}); ////////////////////////////////////
// experiment fetching and checking time

fetch(chrome.runtime.getURL("api/full/index.js")).then(function (x) {
  return x.text();
}).then(function (content) {
  console.log("[".concat(LIB, ".").concat(+Date.now(), "] got fetch result \"").concat(content.slice(0, 16), "\u2026\" (").concat(content.length / 1000., "k)"));
...
chrome.runtime.onConnect.addListener(function (port) {
  console.log("[".concat(LIB, ".").concat(+Date.now(), "] received connection"));
  var portFromCS = port;
  portFromCS.postMessage({
    greeting: "hi from background script!"
  });
  portFromCS.onMessage.addListener(function (m) {
    console.log("[".concat(LIB, ".").concat(+Date.now(), "] received message from content script"));
...
['blocking']);
},{"babel-polyfill":"../../../node_modules/babel-polyfill/lib/index.js"}]},{},["background/background.js"], null)
