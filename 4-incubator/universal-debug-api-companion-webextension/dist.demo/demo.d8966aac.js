...
},{}],"avdb":[function(require,module,exports) {
...
},{"@offirmo/practical-logger-types":"avdb"}],"PZGy":[function(require,module,exports) {
"use strict";
...
exports.Logger = practical_logger_types_1.Logger;
exports.LoggerCreationParams = practical_logger_types_1.LoggerCreationParams;
},{"@offirmo/practical-logger-types":"avdb"}],"kYDl":[function(require,module,exports) {
"use strict";
...
exports.Logger = practical_logger_types_1.Logger;
exports.LoggerCreationParams = practical_logger_types_1.LoggerCreationParams;
},{"./v1":"zaXi","@offirmo/practical-logger-types":"avdb"}],"Az9r":[function(require,module,exports) {
"use strict";
...
function demo_logger_levels(logger) {
  ...
  [...ALL_LOG_LEVELS].reverse().forEach(level => logger[level](`demo with level "${level}"`, {
    level,
    foo: 42
  }));
  /*
...
function demo_group(logger) {
  ...
  logger.groupEnd();
  logger.groupCollapsed('level 2b (-)'); // no output

  logger.group('level 3a (+)'); // no output

  logger.groupEnd();
  logger.groupEnd();
  logger.groupCollapsed('level 2c (-)'); // no output
...
//# sourceMappingURL=demo.d8966aac.js.map